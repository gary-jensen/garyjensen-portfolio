...
function DitheredWaves({
	...
	// Create material imperatively so uniform mutations go directly to Three.js
	// without passing through R3F's prop reconciler.
	...
	/* eslint-disable react-hooks/immutability -- Three.js shaders update uniforms in useFrame. */
	useFrame(({ clock }) => {
